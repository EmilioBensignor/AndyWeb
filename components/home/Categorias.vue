<template>
    <DefaultSection
        class="obras-section h-[200vh] bg-gradient-to-t from-[rgba(25,25,25,0)] from-0% to-[rgba(25,25,25,1)] to-10% px-5 md:px-10 xl:px-20 -mb-44 md:-mb-48 xl:-mb-52">
        <DefaultContent class="h-full relative pt-52 md:pt-60 xl:pt-72">
            ...
            <div class="w-full max-w-6xl mx-auto absolute inset-0 h-full">
                <div ref="card1" class="w-full max-w-[180px] md:max-w-[300px] md:h-[400px] absolute left-0 top-1/3 translate-y-[200px]">
                    <div class="h-full bg-light rounded-[20px] preserve-3d perspective-800">
                        <NuxtImg :src="`/images/home/${cards[0].img}-Andy-Loisch.jpg`"
                            :alt="`${cards[0].title} Andy Loisch`" class="w-full h-full md:max-h-[320px] rounded-t-[20px] object-cover" />
                ...
                <div ref="card2" class="w-full max-w-[180px] md:max-w-[300px] md:h-[400px] absolute right-0 top-1/2 translate-y-[200px]">
                    <div class="h-full bg-light rounded-[20px] preserve-3d perspective-800">
                        <NuxtImg :src="`/images/home/${cards[1].img}-Andy-Loisch.jpg`"
                            :alt="`${cards[1].title} Andy Loisch`" class="w-full h-full md:max-h-[320px] rounded-t-[20px] object-cover" />
                        <div class="py-6 text-center">
                ...
                <div ref="card3" class="w-full max-w-[180px] md:max-w-[300px] md:h-[400px] absolute left-0 top-3/4 translate-y-[200px]">
                    <div class="h-full bg-light rounded-[20px] preserve-3d perspective-800">
                        <NuxtImg :src="`/images/home/${cards[2].img}-Andy-Loisch.jpg`"
                            :alt="`${cards[2].title} Andy Loisch`" class="w-full h-full md:max-h-[320px] rounded-t-[20px] object-cover" />
                        <div class="py-6 text-center">
