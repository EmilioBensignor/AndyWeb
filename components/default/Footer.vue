<template>
    <footer
        class="relative z-[2] bg-[url('/images/backgrounds/Textura-Andy-Loisch.png')] bg-cover bg-center bg-no-repeat text-light p-5 pt-36 md:pt-72 xl:pt-80 md:px-10 xl:px-20 2xl:px-32 md:pb-8 xl:pb-10">
